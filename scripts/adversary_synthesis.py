...
if __name__ == "__main__":
    ...
    if content_index != 999:
        ...
        if content_im.shape[1] == 1: #BW images
            content_im = torch.cat((content_im, content_im, content_im), axis=1)
        else:
    ...
    if style_index != 999:
        ...
        if style_im.shape[1] == 1:
            style_im = torch.cat((style_im, style_im, style_im), axis=1)
        else:
            if model == "vgg_normalized":
